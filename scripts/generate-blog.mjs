...
async function buildPost(fileName) {
  ...
  return {
    ...
    ctaTitle: requireString(parsed.data, "ctaTitle", fileName),
    ctaDescription: requireString(parsed.data, "ctaDescription", fileName),
    ctaLabel: requireString(parsed.data, "ctaLabel", fileName),
    ctaHref: requireString(parsed.data, "ctaHref", fileName),
