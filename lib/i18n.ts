...
const EN_DICTIONARY = {
  common: {
    ...
    nav: {
      ...
      language: "Language",
      blogLanguageNotice: "Language preference saved. The Blog remains in English.",
  ...
  home: {
    ...
    blogTitle: "Troubleshooting from the workbench.",
    blogIntro:
      "Five practical English articles about suspicious pixels, replacement screens, calibration, OLED wear, and tearing.",
    allBlog: "Read the English blog",
...
const ZH_DICTIONARY = {
  common: {
    ...
    nav: {
      ...
      close: "关闭导航",
      language: "语言",
      blogLanguageNotice: "语言偏好已保存。博客正文仍使用英文。",
      switchToEnglish: "Switch to English",
      switchToChinese: "切换到简体中文",
    },
    footer: {
  ...
  home: {
    ...
    blogTitle: "维修台上的排查经验。",
    blogIntro: "5 篇英文实用文章，讲清可疑像素、换屏故障、色彩校准、OLED 老化和画面撕裂。",
    allBlog: "阅读英文博客",
    faqTitle: "直接说答案。",
...
const DE_DICTIONARY = {
  common: {
    ...
    nav: {
      ...
      blogLanguageNotice: "Spracheinstellung gespeichert. Der Blog bleibt auf Englisch.",
  ...
  home: {
    ...
    blogTitle: "Fehlersuche direkt von der Werkbank.",
    blogIntro:
      "Fünf praktische englische Artikel über verdächtige Pixel, Displaytausch, Kalibrierung, OLED-Verschleiß und Tearing.",
    allBlog: "Englischen Blog lesen",
